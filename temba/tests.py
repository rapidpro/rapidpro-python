...
class TembaClientTest(unittest.TestCase):
    ...
    def test_get_field(self, mock_get):
        # check single item response
        mock_get.return_value = MockResponse(200, _read_json('fields_single'))
        ...
        # check multiple item response
        mock_get.return_value = MockResponse(200, _read_json('fields_multiple'))
    ...
    def test_get_flows(self, mock_get):
        # check no params
        mock_get.return_value = MockResponse(200, _read_json('flows_multiple'))
