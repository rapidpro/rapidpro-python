...
class TembaClientTest(TembaTest):
    ...
    def test_update_label(self, mock_request):
        ...
        expected_body = {"uuid": "affa6685-0725-49c7-a15a-96f301d996e4", "name": "Really High Priority"}
        self.assertRequest(mock_request, "post", "labels", data=expected_body)
